...
public class App {
    public static void main(String[] args) { //type “psvm + tab” to autocreate this
        ...
        get("/categories/:category_id/tasks/:task_id/delete", (req, res) -> {
            ...
            taskDao.deleteTask(idOfTaskToDelete);
            res.redirect("/");
            return null;
        }, new HandlebarsTemplateEngine());
...
//            //use it to find task
//            int category = foundTask.getCategoryId();
//            model.put("task", category); //add it to model for template to display
//            return new ModelAndView(model, "task-detail.hbs"); //individual task page.
//        }, new HandlebarsTemplateEngine());
//
//        //get: show a form to update a task
...
//            String newContent = req.queryParams("description");
//            int idOfTaskToEdit = Integer.parseInt(req.params("id"));
//            taskDao.update(idOfTaskToEdit, newContent, 1); //We are manually hardcoding category Id for now
//            res.redirect("/");
//            return null;
//        }, new HandlebarsTemplateEngine());
//
